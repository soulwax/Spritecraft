...
void main() {
  group('SpriteCraftSchemaMigrations', () {
    test('migrates older project-shaped records with missing modern fields', () {
    ...
    test('StudioHistoryEntry.fromJson normalizes legacy payloads', () {
      ...
      expect(entry.updatedAt.toUtc().toIso8601String(), startsWith('2026-03-28T10:00:00'));
    ...
    test('migrates older render metadata to the current schema', () {
      final Map<String, Object?> migrated =
          SpriteCraftSchemaMigrations.migrateRenderMetadata(
        <String, dynamic>{
          'image': <String, Object>{'path': 'hero.png', 'width': 64, 'height': 64},
